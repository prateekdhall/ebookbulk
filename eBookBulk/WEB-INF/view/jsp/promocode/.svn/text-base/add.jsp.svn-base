...
<select id="STYLEID" onChange="Display(this);">
...
<select id="TYPEID" onChange="Display(this);">
...
<label class="labelTxt"><s:text name="codeConfig.codePrefix"/>:</label>
 <input type="text" name="prefix" size="34" id="singleprefixid">
</div>
<div ID="MULTIPREFIX" style="display:none;">
<div class="col-1">
<label class="labelTxt"><s:text name="codeConfig.codePrefix"/>:</label>
<input type="text" name="prefix" size="34" id="multiprefixid">
</div>
<div class="col-2">
<label class="labelTxt"><s:text name="codeConfig.codeQuantity"/>:</label>
...
<div class="col-1">
	...
	<div class="col1">
	<label>&nbsp;</label>
		<table class="tableClass" height="24px">
	    	<tr>
	   			<td width="208">
...
<div class="clear"> </div>
	<div class="col1">
		<label >&nbsp;</label> 
		<table class="tableClass"  height="28px">
	    	<tr>
	   			<td width="208">
...
<s:form  method="post" namespace="/ebbs" action="addPromocode" theme="css_xhtml">     
...
<s:hidden name="codeValue.promoCode" id="promoCodeId"/>
	...
	<div class="btnWrapper">
		<s:submit value="Submit" theme="simple" cssClass="submit_btn" onclick="beforeSubmit()"/>
...
function onLoad()
{
	...
	if(document.getElementById('TYPEID').value=='MULTI')
	{
		document.getElementById('multiautoid').value=document.getElementById('codeSize').value;	
	}
	else if(document.getElementById('TYPEID').value=='SINGLE')
	{
