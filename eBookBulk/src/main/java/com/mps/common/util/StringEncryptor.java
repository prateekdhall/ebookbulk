...
public class StringEncryptor
{
	...
	public static void main(String[] args)
	{
		...
		// System.out.println(st.encrypt("ftp://test1:test1@localhost:21/test"));
		System.out.println(st.encrypt("ftp://sudhir:qwer1234$@172.29.0.16:21/"));
		
		// vxbnCikJEq8%2BcQQATwrvFKcmqaOVh62eDBeiXyCe8rK0OsZF6vsKtA%3D%3D
		
		// System.out.println(st.decrypt("vxbnCikJEq8%2BcQQATwrvFKcmqaOVh62eDBeiXyCe8rK0OsZF6vsKtA%3D%3D"));
